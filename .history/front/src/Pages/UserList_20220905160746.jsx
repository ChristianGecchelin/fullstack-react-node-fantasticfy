...
export const UserList = () => {
  ...
  const filterByName = () => {
    ...
    let result = inmutableList.filter(el => inmutableList.first_name.includes(el.first_name) || inmutableList.first_name.includes(el.last_name)|| inmutableList.first_name.includes(el.username)
